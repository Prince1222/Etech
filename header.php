      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'ssd.php') || ($cur_page == 'ssd-add.php') || ($cur_page == 'ssd-edit.php') || ($cur_page == 'ram.php') || ($cur_page == 'ram-add.php') || ($cur_page == 'ram-edit.php') || ($cur_page == 'district.php') || ($cur_page == 'district-add.php') || ($cur_page == 'district-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="ssd.php"><i class="fa fa-circle-o"></i> SSD</a></li>
                            <li><a href="ram.php"><i class="fa fa-circle-o"></i> Ram</a></li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product.php">
                            <i class="fa fa-plus-circle"></i> <span>View / Add Products</span>
                        </a>
                    </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'social-media.php') ) {echo 'active';} ?>">
			          <a href="social-media.php">
			            <i class="fa fa-share-square"></i> <span>Social Media</span>
			          </a>
			        </li>
      			</ul>
    		</section>
